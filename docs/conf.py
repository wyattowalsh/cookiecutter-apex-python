...
html_baseurl = 'https://cookiecutter-python.readthedocs.io'
...
html_theme_options = {
    ...
    "primary_sidebar_end": ["sidebar-divider", "navbar-logo"],
    ...
    "icon_links": [
        {
            ...
            "url": "https://github.com/wyattowalsh/cookiecutter-python",  # required
